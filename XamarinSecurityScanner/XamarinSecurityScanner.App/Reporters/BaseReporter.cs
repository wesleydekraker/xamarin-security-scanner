...
{
    abstract class BaseReporter : IVulnerabilityReporter
    {
        public int VulnerabilityCount { get; private set; }

        public void Report(Vulnerability vulnerability)
        {
            VulnerabilityCount++;
        ...
        public abstract void Process(Vulnerability vulnerability);
