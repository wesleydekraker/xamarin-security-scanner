...
{
    internal class WorldReadableAnalyzer : CsAnalyzer
    {
        // From /qark/plugins/file/file_permissions.py, under Apache License, Version 2.0.
        private const string WorldReadableMode = "FileCreationMode.WorldReadable";
